import type { BoxConfig, HandlingFees, ShipperAddress } from "../types";

export const SHIPPER_ADDRESS: ShipperAddress = {
...
export function getConfig(): AppConfig {
  return {
    localDeliveryZips: LOCAL_DELIVERY_ZIPS,
    shipperAddress: SHIPPER_ADDRESS,
    boxConfigs: BOX_CONFIGS,
    handlingFees: HANDLING_FEES,
    priorityFeeCents: PRIORITY_FEE_CENTS,
  };
}
